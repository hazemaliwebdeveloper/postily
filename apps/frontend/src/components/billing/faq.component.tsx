  ...
  return [
    ...(user?.allowTrial
      ? [
        {
          title: t(
            'faq_am_i_going_to_be_charged_by_pozmixal',
            'Am I going to be charged by Pozmixal?'
          ),
          description: t(
            'faq_to_confirm_credit_card_information_pozmixal_will_hold',
            'To confirm credit card information Pozmixal will hold $2 and release it immediately'
          ),
        },
      ]
      : []),
    {
      title: t(
        'faq_can_i_trust_pozmixal_gitroom',
        `Can I trust ${isGeneral ? 'Pozmixal' : 'Gitroom'}?`
      ),
      description: t(
        'faq_pozmixal_gitroom_is_proudly_proprietary',
        `${isGeneral ? 'Pozmixal' : 'Gitroom'
        } is a proprietary, enterprise-grade platform. We believe in providing a secure and reliable service. You can contact our sales team for more information.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_pozmixal_gitroom_allows_you_to_schedule_posts',
        `${isGeneral ? 'Pozmixal' : 'Gitroom'
